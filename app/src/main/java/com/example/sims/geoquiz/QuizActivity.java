...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            mCheatedOnQuestion = savedInstanceState.getBooleanArray(KEY_SHOWN);
        }
    ...
    public void onSaveInstanceState(Bundle savedInstanceState) {
        ...
        Log.i(TAG, "onSaveInstanceState " + mCheatedOnQuestion[mCurrentIndex]);
        savedInstanceState.putBooleanArray(KEY_SHOWN, mCheatedOnQuestion);
